...
const SongRow = ({ item, showPlayingIcon = false,  onTitleClick, onAvatarClick, onAddToPlaylist, onViewArtist }) => {
    ...
    return (
        <div className={styles["sr-row"]}>

            {/* AVATAR + ICON isPlaying overlay */}
            <button className={styles["sr-avatar-wrapper"]} onClick={handleAvatarClick}>
                <img className={styles["sr-cover"]} src={item.imageUrl} alt="" />

                {/* overlay khi HOVER */}
                {!showPlayingIcon && (
                    <div className={styles["sr-cover-hover"]}>
                        <div className={styles["sr-play-icon"]} />
                    </div>
                )}
            ...
            {/* META */}
            <div className={styles["sr-meta"]}>
                <button className={styles["sr-title"]}
